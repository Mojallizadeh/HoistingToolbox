function F = control_13_SMC_single_last_implicit(xd, vd, x, v, theta, theta_dot,cont_param_13,h,cart_mass,payload_mass,cable_mass_total,hook_mass,cable_length,last_piece_length)
